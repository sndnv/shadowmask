...
pub fn requests() -> Vec<EndpointCase> {
    vec![
        ...
        case(
            "movie_collections",
            "GET",
            "/api/v1/movies/m1/collections",
            Token::User,
            None,
        ),
        case(
            "movie_collections_none",
            "GET",
            "/api/v1/movies/m2/collections",
            Token::User,
            None,
        ),
        case(
        ...
        case(
            "admin_jobs_active",
            "GET",
            "/api/v1/admin/jobs?state=active",
            Token::Admin,
            None,
        ),
        case(
            "admin_jobs_filtered",
            "GET",
            "/api/v1/admin/jobs?filter=artwork",
            Token::Admin,
            None,
        ),
        case(
            "admin_jobs_paged",
            "GET",
            "/api/v1/admin/jobs?offset=1&limit=1",
            Token::Admin,
            None,
        ),
        case(
